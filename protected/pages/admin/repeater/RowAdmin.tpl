...
<!-- 	#  -->
	<td style="border-top: 1px solid #415567;">
		...
		<com:TActiveHiddenField id="id" Value="<%#$this->Data->acc_id%>" />
	</td>
	...
	<td style="text-align: center;border-top: 1px solid #415567;">
		<a data-toggle="modal" data-target="#ModalDelete<%#$this->Data->acc_id%>">
			<img src="image/icon/delete1.png" style="width:25px;" title=" حذف " />
		</a>
		<div class="modal fade" id="ModalDelete<%#$this->Data->acc_id%>" tabindex="-1" role="dialog"
