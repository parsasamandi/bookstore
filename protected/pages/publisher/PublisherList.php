<?php
class PublisherList extends TPage{
    ...
    {   
        ...
        return PublisherRecord::finder()->count($criteria);
    }
    ...
    protected function getSearchAdditonalCondition($t1=false)
    {
        ...
        {
            $con .= (($t?" AND ":"")."(publisher_name like '%".  $this->txtSearchName->Text . "%')");
            $t = true;
        }
        return $con;
    }
    ...
    protected function getData($offset,$limit){
        ...
        $c = PublisherRecord::finder()->findAll($criteria);
        return $c;
    }
