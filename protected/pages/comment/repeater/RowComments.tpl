<com:TActiveHiddenField id="id" Value="<%#$this->Data->comment_id%>"/>
<tr class="even pointer" style="color:#415567;">
    ...
    <td style="text-align: center;border-top: 1px solid #415567;">
        <a data-toggle="modal" data-target="#ModalDelete<%#$this->Data->comment_id%>">
			<img src="image/icon/delete1.png" style="width:25px;" title=" حذف " />
		</a>
	</td>
</tr>
<div class="modal fade" id="ModalDelete<%#$this->Data->comment_id%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		...
		<div style="font-family:BYekan;text-align:right;direction:rtl;" class="modal-body modal_font">
		   آیا از حذف پیام <%#$this->Data->name%> مطمئن هستید؟
		</div>
