...
<!-- 	#  -->
	<td style="border-top: 1px solid #415567;">
		...
		<com:TActiveHiddenField id="id" Value="<%#$this->Data->author_id%>" />
	</td>
...
<!-- desc  -->
	...
	<!-- 	delete	 -->
	<td style="text-align: center;border-top: 1px solid #415567;">
		<a data-toggle="modal" data-target="#ModalDelete<%#$this->Data->author_id%>">
			<img src="image/icon/delete1.png" style="width:25px;" title=" حذف " />
		</a>
		<div class="modal fade" id="ModalDelete<%#$this->Data->author_id%>" tabindex="-1" role="dialog"
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="height:170px;">
						<p style=" font-family: yekan; font-size: 15px;">
							...
							<p style=" font-family: yekan; font-size: 15px;"><b>  کد محصول : <%#$this->Data->author_id%></b></p> 
