...
<!-- 	#  -->
	...
	<td style="border-top: 1px solid #415567;">
		<p style="text-align: center;">
			<img src="<%#$this->Data->pic%>" style="width: 50px;" />
		</p>
	</td>
	...
	<td style="text-align: center;border-top: 1px solid #415567;">
		<a data-toggle="modal" data-target="#ModalDelete<%#$this->Data->c_id%>">
			<img src="image/icon/delete1.png" style="width:25px;" title=" حذف " />
		</a>
		<div class="modal fade" id="ModalDelete<%#$this->Data->c_id%>" tabindex="-1" role="dialog"
