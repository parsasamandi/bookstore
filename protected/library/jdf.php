<?php /* In the name of Allah = ط¨ط³ظ… ط§ظ„ظ„ظ‘ظ‡ ط§ظ„ط±ظ‘ط­ظ…ظ† ط§ظ„ط±ظ‘ط­غŒظ… */

/**
 * @ظپط§ط±ط³غŒ : طھظˆط§ط¨ط¹ ط²ظ…ط§ظ† ظˆ طھط§ط±غŒط® ظ‡ط¬ط±غŒ ط´ظ…ط³غŒ (ط¬ظ„ط§ظ„غŒ) ط¯ط± ظ¾غŒ ط§ع† ظ¾غŒ
...
function jdate($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
 ...
 for($i=0; $i<$sl; $i++){
  ...
  switch($sub){
	...
	$out.=$date[0].':'.$date[1].':'.$date[6].' '.$date[4].' '.$key['rh'].'طŒ '.$j_d.' '.$key['mm'].' '.$j_y;
	break;
...
function jstrftime($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
 ...
 for($i=0; $i<$sl; $i++){
  ...
  switch($sub){
	...
	$out.=$date[1].':'.$date[2].':'.$date[5].' '.date('P',$ts).' '.$key['rh'].'طŒ '.$j_d.' '.$key['mm'].' '.$j_y;
	break;
...
function jdate_words($array,$mod=''){
 ...
 ,substr($num,0,2)).((substr($num,2,2)=='00')?'':' ظˆ '):'').$h3.$p34.$h34.$h4;
	...
	case'mm':
	$key=array('ظپط±ظˆط±ط¯غŒظ†','ط§ط±ط¯غŒط¨ظ‡ط´طھ','ط®ط±ط¯ط§ط¯','طھغŒط±','ظ…ط±ط¯ط§ط¯','ط´ظ‡ط±غŒظˆط±','ظ…ظ‡ط±','ط¢ط¨ط§ظ†','ط¢ط°ط±','ط¯غŒ','ط¨ظ‡ظ…ظ†','ط§ط³ظپظ†ط¯');
...
function gregorian_to_jalali($gy,$gm,$gd,$mod=''){
	list($gy,$gm,$gd)=explode('_',tr_num($gy.'_'.$gm.'_'.$gd));/* <= Extra :ط§ظٹظ† ط³ط·ط± طŒ ط¬ط²ط، طھط§ط¨ط¹ ط§طµظ„ظٹ ظ†ظٹط³طھ */
...
function jalali_to_gregorian($jy,$jm,$jd,$mod=''){
	list($jy,$jm,$jd)=explode('_',tr_num($jy.'_'.$jm.'_'.$jd));/* <= Extra :ط§ظٹظ† ط³ط·ط± طŒ ط¬ط²ط، طھط§ط¨ط¹ ط§طµظ„ظٹ ظ†ظٹط³طھ */
 if($jy > 979){
  $gy=1600;
  $jy-=979;
 }else{
